...
var _default = Slide;
exports.default = _default;
},{"@dogstudio/highway":"../node_modules/@dogstudio/highway/build/highway.module.js","gsap":"../node_modules/gsap/index.js"}],"js/renderer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.QuizBank = exports.QuizMaker = void 0;
...
// QUIZ MAKER
// ==========
var QuizMaker = /*#__PURE__*/function (_Highway$Renderer) {
  _inherits(QuizMaker, _Highway$Renderer);

  var _super = _createSuper(QuizMaker);
  ...
  _createClass(QuizMaker, [{
    ...
    value: function onEnterCompleted() {
      ...
      var wrongOneAnswer = document.querySelector('.wrongOneAnswer');
      var wrongTwoAnswer = document.querySelector('.wrongTwoAnswer');
      var wrongThreeAnswer = document.querySelector('.wrongThreeAnswer');
      var addQuestionBtn = document.querySelector('.addBtn');
      var finishQuizBtn = document.querySelector('.finishBtn');
      ...
      finishQuizBtn.addEventListener('click', finishQuiz); // Quiz Array Object

      var quiz; // Fetches quiz array object from localStorage if title is provided

      if (localStorage.getItem('quiz') === null) quiz = [];else quiz = JSON.parse(localStorage.getItem('quiz')); // Checks if quiz already exists

      function duplicateQuizWarning() {
        if (quiz.map(function (item) {
          return item.title;
        }).indexOf(quizTitle.value) >= 0) {
      ...
      function finishQuiz() {
        var index = quiz.map(function (item) {
          return item.title;
      ...
      function checkTitle() {
        ...
        else if (quiz.map(function (item) {
            return item.title;
          }).indexOf(quizTitle.value) >= 0) {
            errorMsgTitle.textContent = 'Quiz already exists';
...
var QuizBank = /*#__PURE__*/function (_Highway$Renderer2) {
  _inherits(QuizBank, _Highway$Renderer2);

  var _super2 = _createSuper(QuizBank);

  function QuizBank() {
    _classCallCheck(this, QuizBank);
    ...
    function onEnter() {
      ...
      function getQuizTitle() {
        quiz.forEach(function (title) {
          ...
          titleDiv.classList.add('quiz-bank__quiz'); // Title LI

          var newTitle = document.createElement('h3');
          newTitle.textContent = title.title;
          newTitle.classList.add('quiz-bank__quiz__title');
          titleDiv.appendChild(newTitle); // Play Button

          var playButtonContainer = document.createElement('p');
          ...
          playButtonContainer.appendChild(playButton); // Trash Button

          var trashButtonContainer = document.createElement('p');
...
},{"@dogstudio/highway":"../node_modules/@dogstudio/highway/build/highway.module.js"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
// LOGO ANIMATION
// ===============
var textWrapper = document.querySelector('.header__logo .header__letters');
...
var H = new _highway.default.Core({
  renderers: {
    maker: _renderer.QuizMaker,
    bank: _renderer.QuizBank
  },
  transitions: {
    default: _transition.default
  }
});
},{"@dogstudio/highway":"../node_modules/@dogstudio/highway/build/highway.module.js","./transition":"js/transition.js","./renderer":"js/renderer.js","../sass/style.scss":"sass/style.scss"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
